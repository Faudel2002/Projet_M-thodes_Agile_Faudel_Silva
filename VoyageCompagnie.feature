...
When jajoute le voyage à la compagnie
...
Scenario Outline: refus dajout en double
Given une compagnie nommée <nomCompagnie> ayant déjà un voyage nommé <nomVoyage>
When j'ajoute à nouveau ce voyage a la compagnie
Then le système refuse lajout en doublon
